...
var photoNames = ['images/pilot_study_photos/J/01.png', 'images/pilot_study_photos/J/02.png'];
...
$(document).keypress(function(e) {
  ...
  window.setTimeout(function(){
    ...
    var webNames = ['first_question.html', 'second_question.html'];
...
class AudioController {
  constructor() {
    this.bgmMusic = new Audio('');
    this.flipSound = new Audio('music/flip02.mp3');
